      ...
      <div className="mx-auto flex w-full max-w-[1440px] items-center justify-between px-5 sm:px-10 lg:px-16">
        ...
        <div className="flex items-center gap-6">
          <div className="hidden md:flex items-center gap-4">
            ...
            <Link href="/profile" aria-label="Profile" className="text-charcoal/70 hover:text-moon-indigo transition-colors relative flex items-center justify-center p-1">
